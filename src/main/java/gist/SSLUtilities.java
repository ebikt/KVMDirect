 ...
 * @author    Tomas Ebenlendr added getSupportedCipherSuites
 *
 * Synopsis:
 *    System.setProperty("https.protocols", "TLSv1.3,TLSv1.2,TLSv1.1,TLSv1,SSLv3,SSLv2Hello");
 *    Security.setProperty("jdk.tls.disabledAlgorithms", "");
 *    System.setProperty("https.cipherSuites",String.join(",",SSLUtilities.getSupportedCipherSuites()));
...
public final class SSLUtilities {
    ...
    /**
     * Get names of all cipher suites. To be used with
     * setProprety("https.cipherSuites"), to enable ciphers that were disabled,
     * e.g. in openjdk 19.
     */
    public static String[] getSupportedCipherSuites() {
        ...
        return eng.getSupportedCipherSuites();
    }
} // SSLUtilities
